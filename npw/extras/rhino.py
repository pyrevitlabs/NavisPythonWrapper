...
Usage:
    ...
    >>> from npw.extras.rhino import Rhino as rc
...
More Information about openNURBES in the links below:
    * `Github Repo
        <https://github.com/mcneel/rhinocommon/tree/rhino3dmio>`_
    * `RhinoCommon API
        <http://developer.rhino3d.com/api/>`_
    * `openNURBS
        <http://developer.rhino3d.com/guides/opennurbs/what-is-opennurbs/>`_

"""

from npw.utils.dotnet import clr
